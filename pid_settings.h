...
namespace pid_settings {
    ...
    PID pid_rotation_speed = PID(0.017f, 0, 0.00006f, 100, 21); // deg/s -> delta pwm //limit 600

    NON_LINEAR_PID pid_rotation = NON_LINEAR_PID(56.0f, 0, 0.20f, 40000, 2000); // deg -> deg/s
